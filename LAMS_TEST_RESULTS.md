...
**Test Execution Date**: Wed Nov 12 04:21:12 IST 2025
...
|--------|--------|--------|---------|-------|
| TC-SIA-001 | Create Draft SIA | PASS | SIA created with ID: 15 |
| TC-SIA-002 | Publish SIA | PASS | SIA published successfully |
| TC-SIA-003 | Schedule Hearing | PASS | Hearing scheduled with ID: 13 |
| TC-NOT-001 | Create Section 11 Notification | PASS | Notification created with ID: 16 |
...
| TC-COMP-001 | Create Parcel Valuation | PASS | Valuation created with ID: 15 |
| TC-COMP-002 | Draft Compensation Award | PASS | Award drafted with ID: 14 |
